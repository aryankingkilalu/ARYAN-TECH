...
const { autotypingCommand, isAutotypingEnabled, handleAutotypingForMessage, handleAutotypingForCommand, showTypingAfterCommand } = require('./aryan/autotyping');
const { autoreadCommand, isAutoreadEnabled, handleAutoread } = require('./aryan/autoread');

// Command imports
const tagAllCommand = require('./aryan/tagall');
const helpCommand = require('./aryan/help');
const banCommand = require('./aryan/ban');
const { promoteCommand } = require('./aryan/promote');
const { demoteCommand } = require('./aryan/demote');
const muteCommand = require('./aryan/mute');
const unmuteCommand = require('./aryan/unmute');
const stickerCommand = require('./aryan/sticker');
const isAdmin = require('./lib/isAdmin');
const warnCommand = require('./aryan/warn');
const warningsCommand = require('./aryan/warnings');
const ttsCommand = require('./aryan/tts');
const { tictactoeCommand, handleTicTacToeMove } = require('./aryan/tictactoe');
const { incrementMessageCount, topMembers } = require('./aryan/topmembers');
const ownerCommand = require('./aryan/owner');
const deleteCommand = require('./aryan/delete');
const { handleAntilinkCommand, handleLinkDetection } = require('./aryan/antilink');
const { handleAntitagCommand, handleTagDetection } = require('./aryan/antitag');
const { Antilink } = require('./lib/antilink');
const { handleMentionDetection, mentionToggleCommand, setMentionCommand } = require('./aryan/mention');
const memeCommand = require('./aryan/meme');
const tagCommand = require('./aryan/tag');
const tagNotAdminCommand = require('./aryan/tagnotadmin');
const hideTagCommand = require('./aryan/hidetag');
const jokeCommand = require('./aryan/joke');
const quoteCommand = require('./aryan/quote');
const factCommand = require('./Aryan/fact');
const weatherCommand = require('./Aryan/weather');
const newsCommand = require('./aryan/news');
const kickCommand = require('./aryan/kick');
const simageCommand = require('./aryan/simage');
const attpCommand = require('./aryan/attp');
const { startHangman, guessLetter } = require('./aryan/hangman');
const { startTrivia, answerTrivia } = require('./aryan/trivia');
const { complimentCommand } = require('./aryan/compliment');
const { insultCommand } = require('./aryan/insult');
const { eightBallCommand } = require('./aryan/eightball');
const { lyricsCommand } = require('./aryan/lyrics');
const { dareCommand } = require('./aryan/dare');
const { truthCommand } = require('./aryan/truth');
const { clearCommand } = require('./aryan/clear');
const pingCommand = require('./aryan/ping');
const aliveCommand = require('./aryan/alive');
const blurCommand = require('./aryan/img-blur');
const { welcomeCommand, handleJoinEvent } = require('./aryan/welcome');
const { goodbyeCommand, handleLeaveEvent } = require('./aryan/goodbye');
const githubCommand = require('./aryan/github');
const { handleAntiBadwordCommand, handleBadwordDetection } = require('./lib/antibadword');
const antibadwordCommand = require('./aryan/antibadword');
const { handleChatbotCommand, handleChatbotResponse } = require('./aryan/chatbot');
const takeCommand = require('./aryan/take');
const { flirtCommand } = require('./Aryan/flirt');
const characterCommand = require('./Aryan/character');
const wastedCommand = require('./aryan/wasted');
const shipCommand = require('./aryan/ship');
const groupInfoCommand = require('./aryan/groupinfo');
const resetlinkCommand = require('./aryan/resetlink');
const staffCommand = require('./aryan/staff');
const unbanCommand = require('./aryan/unban');
const emojimixCommand = require('./Teddy/emojimix');
const { handlePromotionEvent } = require('./aryan/promote');
const { handleDemotionEvent } = require('./Aryan/demote');
const viewOnceCommand = require('./aryan/viewonce');
const clearSessionCommand = require('./Aryan/clearsession');
const { autoStatusCommand, handleStatusUpdate } = require('./aryan/autostatus');
const { simpCommand } = require('./aryan/simp');
const { stupidCommand } = require('./aryan/stupid');
const stickerTelegramCommand = require('./Aryan/stickertelegram');
const textmakerCommand = require('./aryan/textmaker');
const { handleAntideleteCommand, handleMessageRevocation, storeMessage } = require('./Aryan/antidelete');
const clearTmpCommand = require('./aryan/cleartmp');
const setProfilePicture = require('./aryan/setpp');
const { setGroupDescription, setGroupName, setGroupPhoto } = require('./Aryan/groupmanage');
const instagramCommand = require('./aryan/instagram');
const facebookCommand = require('./Aryan/facebook');
const spotifyCommand = require('./aryan/spotify');
const playCommand = require('./aryan/play');
const tiktokCommand = require('./aryan/tiktok');
const songCommand = require('./aryan/song');
const aiCommand = require('./aryan/ai');
const urlCommand = require('./aryan/url');
const { handleTranslateCommand } = require('./aryan/translate');
const { handleSsCommand } = require('./aryan/ss');
const { addCommandReaction, handleAreactCommand } = require('./lib/reactions');
const { goodnightCommand } = require('./aryan/goodnight');
const { shayariCommand } = require('./aryan/shayari');
const { rosedayCommand } = require('./aryan/roseday');
const imagineCommand = require('./aryan/imagine');
const videoCommand = require('./aryan/video');
const sudoCommand = require('./aryan/sudo');
const { miscCommand, handleHeart } = require('./aryan/misc');
const { animeCommand } = require('./aryan/anime');
const { piesCommand, piesAlias } = require('./aryan/pies');
const stickercropCommand = require('./aryan/stickercrop');
const updateCommand = require('./aryan/update');
const removebgCommand = require('./aryan/removebg');
const { reminiCommand } = require('./aryan/remini');
const { igsCommand } = require('./aryan/igs');
const { anticallCommand, readState: readAnticallState } = require('./aryan/anticall');
const { pmblockerCommand, readState: readPmBlockerState } = require('./Aryan/pmblocker');
const settingsCommand = require('./aryan/settings');
const soraCommand = require('./Aryan/sora');
    ...
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                ...
                const ownerCommand = require('./Teddy/owner');
